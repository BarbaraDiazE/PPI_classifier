...
root = {
    ...
    "root_chem_space": "/home/babs/Documents/DIFACQUIM/PPI_classifier/phase-2_a/Unsupervised_Models/chemical_space/tsne",
...
print(str(root["root"]))
data = pd.read_csv(str(root["root"]) + str("dataset_ecfp6_p2.csv"))
