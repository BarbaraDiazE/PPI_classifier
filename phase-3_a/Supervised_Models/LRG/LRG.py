...
class LRG:
    ...
    def report(self, ref_output):
        ...
        lrg_report(ref_output, self.Data, self.parameters, self.predictions["y_test"], self.predictions["predictions"], self.descriptors, self.atributes, roc_auc,  self.root["root_Info"])
