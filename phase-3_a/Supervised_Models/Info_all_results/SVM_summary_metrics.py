...
from scripts_plots.SVM.SVM_filter_metrics import SVM_M
...
def storage_info():
    # precision
    x1, precision, X1 = SVM_M().precision()
    # balanced acc
    x2, balanced_accuracy, X2 = SVM_M().balanced_acc()
    # f1
    x3, f1, X3 = SVM_M().f1()
    # recall
    x4, recall, X4 = SVM_M().recall()
    ...
    print(DF.head())
    DF.to_csv(
        "/home/babs/Documents/DIFACQUIM/PPI_classifier/phase-3_a/Supervised_Models/Info_all_results/summary_metrics/SVM_summary_metrics.csv"
    )
    # print(DF.dtypes)
    return DF
