...
from RF_filter_metrics import RF_M
...
plt.savefig(
    "/home/babs/Documents/DIFACQUIM/PPI_classifier/phase-3_a/Supervised_Models/Info_all_results/plot_metrics/RF_p3.png",
    dpi=200,
)
plt.show()
