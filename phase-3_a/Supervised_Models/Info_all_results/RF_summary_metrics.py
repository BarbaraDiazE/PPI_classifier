...
from scripts_plots.RF.RF_filter_metrics import RF_M
...
def storage_info():
    # precision
    x1, precision, X1 = RF_M().precision()
    # balanced acc
    x2, balanced_accuracy, X2 = RF_M().balanced_acc()
    # f1
    x3, f1, X3 = RF_M().f1()
    # recall
    x4, recall, X4 = RF_M().recall()
    ...
    print(DF.head())
    DF.to_csv(
        "/home/babs/Documents/DIFACQUIM/PPI_classifier/phase-3_a/Supervised_Models/Info_all_results/summary_metrics/RF_summary_metrics.csv"
    )
    # print(DF.dtypes)
    return DF
