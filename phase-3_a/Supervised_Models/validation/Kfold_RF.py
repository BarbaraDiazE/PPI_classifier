...
print("###RF1###")
A = Kfold(
    root, "dataset_maccskeys_p2.csv", "RF_p2_F1L6P3ERF2A.pkl", "PPI", descriptors, 0.2
)
A.evaluate_model()
...
print("###RF5###")
A = Kfold(
    root, "dataset_maccskeys_p2.csv", "RF_p2_F1L6P3GRF2A.pkl", "PPI", descriptors, 0.2
)
A.evaluate_model()
...
print("###RF7###")
A = Kfold(
    root, "dataset_maccskeys_p2.csv", "RF_p2_F1L6P3GRF3A.pkl", "PPI", descriptors, 0.3
)
A.evaluate_model()
