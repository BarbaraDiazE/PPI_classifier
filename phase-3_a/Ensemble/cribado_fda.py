"""Virtual screaning of FDA dataset (including training and test set)"""
import pandas as pd
...
data.to_csv("FDA_ensemble_predictions_DF.csv")
...
print("percentage positive predictions: ", (positive_predictions[0] / n_fda) * 100)
