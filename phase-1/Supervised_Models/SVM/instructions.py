...
#execute(root, "ECFP6_L6.csv", "PPI", descriptors, 0.2, "linear", None, "F2L6P3SVM1ABN")
#execute(root, "ECFP6_L6.csv", "PPI", descriptors, 0.2, "poly", None, "F2L6P3SVM2ABN")
execute(root, "ECFP6_L6.csv", "PPI", descriptors, 0.2, "rbf", None, "F2L6P3SVM3ABN")
execute(root, "ECFP6_L6.csv", "PPI", descriptors, 0.2, "sigmoid", None, "F2L6P3SVM4ABN")
execute(root, "ECFP6_L6.csv", "PPI", descriptors, 0.3, "linear", None, "F2L6P5SVM1ABN")
#execute(root, "ECFP6_L6.csv", "PPI", descriptors, 0.3, "poly", None, "F2L6P5SVM2ABN")
execute(root, "ECFP6_L6.csv", "PPI", descriptors, 0.3, "rbf", None, "F2L6P5SVM3ABN")
execute(root, "ECFP6_L6.csv", "PPI", descriptors, 0.3, "sigmoid", None, "F2L6P5SVM4ABN")